...
extension TransportModeExtension on TransportMode {
  ...
  static Widget? _images(TransportMode transportMode, Color? color) {
    switch (transportMode) {
      ...
      case TransportMode.bus:
        return busIcon(color: color ?? const Color(0xFFE91E63));
  ...
  static final _backgroundColors = <TransportMode, Color?>{
    ...
    TransportMode.bus: const Color(0xFFE91E63),
    TransportMode.cableCar: null,
    ...
    // route icons for specific types of transportation
    TransportMode.trufi: const Color(0xFFE91E63),
    TransportMode.micro: const Color(0xFFE91E63),
    TransportMode.miniBus: const Color(0xFFE91E63),
    TransportMode.lightRail: const Color(0xFFE91E63),
  };

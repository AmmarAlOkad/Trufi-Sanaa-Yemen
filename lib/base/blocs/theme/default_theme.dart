...
final theme = ThemeData.from(
  ...
  textTheme: ThemeData.light().textTheme.apply(fontFamily: 'Alexandria'),
).copyWith(
  ...
  textSelectionTheme: TextSelectionThemeData(
    ...
    selectionColor: const Color(0xFFE91E63).withOpacity(0.7),
  ),
);
...
final themeDark = ThemeData.from(
  ...
  textTheme: ThemeData.dark().textTheme.apply(fontFamily: 'Alexandria'),
).copyWith(

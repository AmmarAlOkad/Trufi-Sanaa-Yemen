                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            // Keep the short name to its intrinsic width so it
                            // doesn't force an unnecessary gap. Use Flexible
                            // with flex=0 so it only takes the space it needs.
                            Flexible(
                              flex: 0,
                              child: Text(
                            ...
                            // Allow the last part of the name to take remaining
                            // space and truncate if needed.
                            Flexible(
                              flex: 1,
                              child: Text(

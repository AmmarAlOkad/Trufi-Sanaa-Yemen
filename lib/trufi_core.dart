    ...
    return AppLifecycleReactor(
      child: MultiProvider(
        ...
        child: MaterialApp.router(
          ...
          // Use provided TrufiBaseTheme or default themes so AppBarTheme and
          // colorScheme are applied consistently across all pages.
          theme: trufiBaseTheme?.theme ?? theme,
          darkTheme: trufiBaseTheme?.darkTheme ?? themeDark,
          themeMode: trufiBaseTheme?.themeMode ?? ThemeMode.system,
